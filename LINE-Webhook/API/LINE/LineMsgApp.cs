...
{
    internal class LineMsgApp : WebhookApplication
    {
        private LineMessagingClient messagingClient { get; }
        private TableStorage<EventSourceState> sourceState { get; }
        private BlobStorage blobStorage { get; }

        public LineMsgApp(LineMessagingClient lineMessagingClient)//, TableStorage<EventSourceState> tableStorage, BlobStorage blobStorage)
        {
